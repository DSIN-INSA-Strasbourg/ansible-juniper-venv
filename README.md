...
8. Installing Ansible and the Python `wheel` dependencies, as well as those contained in the `requirements-python.txt` file - unless the `-p` or `--dont-install-python-requirements` option was specified
